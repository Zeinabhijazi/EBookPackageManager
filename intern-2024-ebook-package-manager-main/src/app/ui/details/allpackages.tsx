...
const AllPackagePopUp: React.FC<ModalProps> = ({ bookId, processId }) => {
  ...
  const handleSubmit = async (event: React.FormEvent<HTMLFormElement>) => {
    ...
    try {
      ...
      if (response.status === 201) {
        setSuccessAlert("Added Successfully");
        // Clear the inputs
        setValue("");
      }
    } catch (error: any) {
        ...
        >
          ...
          >
            <Typography variant="h6" gutterBottom>
              Add this book to a specific package:
            </Typography>
...
export default AllPackagePopUp;
